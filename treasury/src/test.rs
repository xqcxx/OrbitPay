...
fn test_cancel_withdrawal() {
    ...
    let proposal_id = client.create_withdrawal(
        ...
        &recipient,
        &500_i128,
        &symbol_short!("cancel_me"),
    );

    // Cancel it as the proposer
    client.cancel_withdrawal(&signer1, &proposal_id);
...
fn test_cancel_unauthorized() {
    ...
    // This should panic because random_user is neither proposer nor admin
    client.cancel_withdrawal(&random_user, &proposal_id);
}
